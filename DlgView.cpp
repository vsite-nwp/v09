...
BEGIN_MESSAGE_MAP(DlgView, CFormView)
	//{{AFX_MSG_MAP(DlgView)
	//}}AFX_MSG_MAP
	ON_EN_KILLFOCUS(IDC_EDIT1, &DlgView::kill_focus)
	ON_EN_KILLFOCUS(IDC_EDIT2, &DlgView::kill_focus)
	ON_EN_KILLFOCUS(IDC_EDIT3, &DlgView::kill_focus)
	ON_EN_KILLFOCUS(IDC_EDIT4, &DlgView::kill_focus)
END_MESSAGE_MAP()
