...
void DlgView::DoDataExchange(CDataExchange* pDX)
{
	...
	//}}AFX_DATA_MAP
	DDX_Text(pDX, IDC_EDIT1, GetDocument()->re.left);
	DDX_Text(pDX, IDC_EDIT2, GetDocument()->re.top);
	DDX_Text(pDX, IDC_EDIT3, GetDocument()->re.right);
	DDX_Text(pDX, IDC_EDIT4, GetDocument()->re.bottom);
}
