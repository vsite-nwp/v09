...
void DlgView::DoDataExchange(CDataExchange* pDX)
{
	...
	//}}AFX_DATA_MAP
	DDX_Text(pDX, IDC_EDIT1, GetDocument()->pr.left);
	DDX_Text(pDX, IDC_EDIT2, GetDocument()->pr.top);
	DDX_Text(pDX, IDC_EDIT3, GetDocument()->pr.right);
	DDX_Text(pDX, IDC_EDIT4, GetDocument()->pr.bottom);
}
