...
void DlgView::DoDataExchange(CDataExchange* pDX)
{
	...
	//}}AFX_DATA_MAP
	DDX_Text(pDX, IDC_EDIT1, GetDocument()->rectWindow.left);
	DDX_Text(pDX, IDC_EDIT2, GetDocument()->rectWindow.top);
	DDX_Text(pDX, IDC_EDIT3, GetDocument()->rectWindow.right);
	DDX_Text(pDX, IDC_EDIT4, GetDocument()->rectWindow.bottom);
}
