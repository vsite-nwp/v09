...
void DlgView::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT4, GetDocument()->mRect.bottom);
	DDX_Text(pDX, IDC_EDIT3, GetDocument()->mRect.right);
	DDX_Text(pDX, IDC_EDIT1, GetDocument()->mRect.left);
	DDX_Text(pDX, IDC_EDIT2, GetDocument()->mRect.top);
