...
void DlgView::DoDataExchange(CDataExchange* pDX)
{
	...
	//}}AFX_DATA_MAP
	DDX_Text(pDX, IDC_EDIT1, GetDocument()->DRect.left);
	DDX_Text(pDX, IDC_EDIT2, GetDocument()->DRect.top);
	DDX_Text(pDX, IDC_EDIT3, GetDocument()->DRect.right);
	DDX_Text(pDX, IDC_EDIT4, GetDocument()->DRect.bottom);
}
