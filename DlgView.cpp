...
void DlgView::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT1, GetDocument()->mojRect.left);
	DDX_Text(pDX, IDC_EDIT2, GetDocument()->mojRect.top);
	DDX_Text(pDX, IDC_EDIT3, GetDocument()->mojRect.right);
	DDX_Text(pDX, IDC_EDIT4, GetDocument()->mojRect.bottom);
